...
app_ui = ui.page_fluid(
    ...
    ui.row(
     ...
     such as Seurat, Scanorama, or ScANVI. Our proxies are available at three stringency levels. Higher stringency levels require the genes to be more similar to each other to be included as proxies.
     """
          ),
    ),
    ui.div(
